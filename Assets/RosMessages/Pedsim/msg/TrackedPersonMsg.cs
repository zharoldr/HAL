...
namespace RosMessageTypes.Pedsim
{
    ...
    public class TrackedPersonMsg : Message
    {
        ...
        public TrackedPersonMsg(ulong track_id, bool is_occluded, bool is_matched, ulong detection_id, DurationMsg age, Geometry.PoseWithCovarianceMsg pose, Geometry.TwistWithCovarianceMsg twist)
        {
